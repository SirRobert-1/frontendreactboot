...
const Home = () => {
  ...
  return (
    <>
      <h2 className="text-center">Catalogo de películas</h2>
      <Form
        className="d-flex col-md-8 offset-md-2 col-lg-6 offset-lg-3 mt-4"
        onSubmit={(e) => buscarPeliculas(searchTerm, e)}
      >
        <Form.Control
          type="search"
